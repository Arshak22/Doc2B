...
export default function SignIn() {
    ...
    const logIn = (e) => {
        ...
        if (email1Error === '' && pass1Error === '') {
            ...
            console.log(`User: ${loginEmail}, pass: ${loginPass}`);
        }
    };
    ...
    const signUp = (e) => {
        ...
        if (nameError === '' && surnameError === '' && email2Error === '' && telError === '' && pass2Error === '' && pass3Error === '' & isChecked) {
            localStorage.setItem('logedIn', 'true');
            window.location.reload();
            console.log(`Name: ${name}, surname: ${surname}, Email: ${email}, Tel: ${tel}, pass: ${pass}, repeatPass: ${repeatPass}`);
        }
    };
    ...
    return (
        ...
        <div className="container">
            <div className="overlay" ref={overlayRef}>
                <div className="sign-in" ref={leftTextRef}>
                    ...
                    <p>Համակարգ մուտք գործելու համար պարզապես սեղմեք ստորև ներկայացված կոճակը:</p>
                    ...
                    <button className="switch-button" id="slide-right-button" onClick={openSignIn}>Մուտք գործել</button>
                </div>
                <div className="sign-up" ref={rightTextRef}>
                    <h1>Ցանկանու՞մ եք ստեղծել հաշիվ</h1>
                    <p>Համակարգում հաշիվ ստեղծելու համար պարզապես լրացրեք անհրաժեշտ դաշտերը:</p>
                    <div className="social-media-buttons">
                        <a href="https://www.facebook.com/doc2b.am" target="_blank" rel="noopener noreferrer"><FaFacebookF className="icon"/></a>
                        <a href="https://t.me/doc2bam" target="_blank" rel="noopener noreferrer"><FaTelegramPlane className="icon"/></a>
                        <a href="https://www.linkedin.com/company/doc2bam/" target="_blank" rel="noopener noreferrer"><FaLinkedinIn className="icon"/></a>
                    ...
                    <button className="switch-button" id="slide-left-button" onClick={openSignUpClicked}>ստեղծել հաշիվ</button>
                </div>
            </div>
            <div className="form">
        ...
        <div className="mobileLogIn">
            ...
            <div className="sign-up">
                {isSignInOpen ? <h1>Ցանկանու՞մ եք ստեղծել հաշիվ</h1>: <h1>Արդեն ունե՞ք հաշիվ</h1>}
                {isSignInOpen ? <p>Համակարգում հաշիվ ստեղծելու համար պարզապես լրացրեք անհրաժեշտ դաշտերը:</p>: <p>Համակարգ մուտք գործելու համար պարզապես սեղմեք ստորև ներկայացված կոճակը:</p>}
                <div className="social-media-buttons">
                    <a href="https://www.facebook.com/doc2b.am" target="_blank" rel="noopener noreferrer"><FaFacebookF className="icon"/></a>
                    <a href="https://t.me/doc2bam" target="_blank" rel="noopener noreferrer"><FaTelegramPlane className="icon"/></a>
                    <a href="https://www.linkedin.com/company/doc2bam/" target="_blank" rel="noopener noreferrer"><FaLinkedinIn className="icon"/></a>
                ...
                {isSignInOpen ? <button className="switch-button" id="slide-left-button" onClick={openSignUpClicked}>ստեղծել հաշիվ</button>: <button className="switch-button" id="slide-right-button" onClick={openSignIn}>Մուտք գործել</button>}
            </div>
        </div>
        </>
    );
