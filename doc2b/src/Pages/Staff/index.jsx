            ...
            <div className={"LeftBlockSection" + (darkMode ? ' Dark' : '')}>
                ...
                <>
                    <div className="InputContainer">
                        <Popup
                            trigger={
                                <div>
                                {currentPage > 0 ? <button className='secondary-add-staff-btn'>Ավելացնել Աշխատակից <span>+</span></button> : null}
                                </div>}
                            position="top center"
                    ...
                    <>
                        <StaffMember currentItems={currentItems} currentPage={currentPage} />
                        <ReactPaginate
                ...
                <div className='no-staff-content'>
                    ...
                    <div className={"empty-content-image-block" + (darkMode ? ' darkWelcome' : '')}>
                        ...
                        <h5>Ավելացրեք նոր աշխատակցի, որպեսզի հետևեք անձնական տեղեկատվությանը և ընթացիկ թարմացումներին</h5>
                    </div>
                    <Popup
                        trigger={
                            <div>
